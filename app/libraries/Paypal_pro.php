...
class PayPal_Pro
{
    ...
    public function __construct($DataArray)
    {
        ...
        $this->AVSCodes = ['A' => 'Address Matches Only (No ZIP)',
     ...
     * @return    array
     */
    public function AddressVerify($DataArray)
    {
     ...
     * @return    boolean
     */
    public function APICallSuccessful($ack)
    {
     ...
     * @return    array
     */
    public function BillAgreementUpdate($DataArray)
    {
     ...
     * @return    array
     */
    public function BillOutstandingAmount($DataArray)
    {
     ...
     * @return    array
     */
    public function BMButtonSearch($DataArray)
    {
        $BMButtonSearchNVP = '&METHOD=BMButtonSearch';

        // BMButtonSearch Fields
        $BMButtonSearchFields = isset($DataArray['BMButtonSearchFields']) ? $DataArray['BMButtonSearchFields'] : [];
     ...
     * @return    array
     */
    public function CallbackResponse($DataArray)
    {
        ...
        $ShippingOptions = isset($DataArray['ShippingOptions']) ? $DataArray['ShippingOptions'] : [];
        $n               = 0;
     ...
     * @return    array
     */
    public function CreateRecurringPaymentsProfile($DataArray)
    {
        $CRPPFieldsNVP = '&METHOD=CreateRecurringPaymentsProfile';
        $OrderItemsNVP = '';

        $CRPPFields = isset($DataArray['CRPPFields']) ? $DataArray['CRPPFields'] : [];
        ...
        $ProfileDetails = isset($DataArray['ProfileDetails']) ? $DataArray['ProfileDetails'] : [];
        ...
        $ScheduleDetails = isset($DataArray['ScheduleDetails']) ? $DataArray['ScheduleDetails'] : [];
        ...
        $BillingPeriod = isset($DataArray['BillingPeriod']) ? $DataArray['BillingPeriod'] : [];
        ...
        $ActivationDetails = isset($DataArray['ActivationDetails']) ? $DataArray['ActivationDetails'] : [];
        ...
        $BillingAddress = isset($DataArray['BillingAddress']) ? $DataArray['BillingAddress'] : [];
        ...
        $ShippingAddress = isset($DataArray['ShippingAddress']) ? $DataArray['ShippingAddress'] : [];
        ...
        $OrderItems = isset($DataArray['OrderItems']) ? $DataArray['OrderItems'] : [];
        $n          = 0;
        $m          = 0;
     ...
     * @return    string
     */
    public function CURLRequest($Request = '', $APIName = '', $APIOperation = '')
    {
        $curl = curl_init();
     ...
     * @return    array
     */
    public function DoDirectPayment($DataArray)
    {
        ...
        $PaymentDetails = isset($DataArray['PaymentDetails']) ? $DataArray['PaymentDetails'] : [];
     ...
     * @return    array
     */
    public function DoExpressCheckoutPayment($DataArray)
    {
        ...
        $DECPFields = isset($DataArray['DECPFields']) ? $DataArray['DECPFields'] : [];
        ...
        $UserSelectedOptions = isset($DataArray['UserSelectedOptions']) ? $DataArray['UserSelectedOptions'] : [];
     ...
     * @return    array
     */
    public function DoMobileCheckoutPayment($DataArray)
    {
        $DMCPFieldsNVP = '&METHOD=DoMobileCheckoutPayment';

        $DMCPFields = isset($DataArray['DMCPFields']) ? $DataArray['DMCPFields'] : [];
     ...
     * @return    array
     */
    public function DoNonReferencedCredit($DataArray)
    {
        ...
        $DNRCFields = isset($DataArray['DNRCFields']) ? $DataArray['DNRCFields'] : [];
     ...
     * @return    array
     */
    public function DoReauthorization($DataArray)
    {
     ...
     * @return    array
     */
    public function DoReferenceTransaction($DataArray)
    {
     ...
     * @return    array
     */
    public function GetAccessPermissionsDetails($Token)
    {
     ...
     * @return    string
     */
    public function GetAVSCodeMessage($AVSCode)
    {
     ...
     * @return    array
     */
    public function GetBalance($DataArray)
    {
     ...
     * @return    string
     */
    public function GetCurrencyCode($CurrencyCodeText)
    {
     ...
     * @return    string
     */
    public function GetCurrencyCodeText($CurrencyCode)
    {
     ...
     * @return    string
     */
    public function GetCVV2CodeMessage($CVV2Code)
    {
     ...
     * @return    array
     */
    public function GetExpressCheckoutPaymentInfo($DataArray)
    {
        $Payments = [];
        $n        = 0;
     ...
     * @return    array
     */
    public function GetOrderItems($DataArray)
    {
        $OrderItems = [];
        $n          = 0;
     ...
     * @return    array
     */
    public function GetPayments($DataArray)
    {
        $Payments = [];
        $n        = 0;
     ...
     * @return    array
     */
    public function GetRecurringPaymentsProfileDetails($DataArray)
    {
        $GRPPDFieldsNVP = '&METHOD=GetRecurringPaymentsProfileDetails';

        $GRPPDFields = isset($DataArray['GRPPDFields']) ? $DataArray['GRPPDFields'] : [];
     ...
     * @return    array
     */
    public function GetRecurringPaymentsProfileStatus($ProfileID)
    {
        $GRPPDFields       = ['profileid' => $ProfileID];
     ...
     * @return    string
     */
    public function GetStateCode($StateOrProvinceName)
    {
     ...
     * @return    string
     */
    public function GetStateName($StateOrProvinceName)
    {
     ...
     * @return    array
     */
    public function GetTransactionDetails($DataArray)
    {
     ...
     * @return    boolean
     */
    public function Logger($filename, $string_data)
    {
     ...
     * @return    array
     */
    public function ManagePendingTransactionStatus($DataArray)
    {
        $MPTSFieldsNVP = '&METHOD=ManagePendingTransactionStatus';

        $MPTSFields = isset($DataArray['MPTSFields']) ? $DataArray['MPTSFields'] : [];
    ...
    public function ManageRecurringPaymentsProfileStatus($DataArray)
    {
        ...
        $MRPPSFields = isset($DataArray['MRPPSFields']) ? $DataArray['MRPPSFields'] : [];
     ...
     * @return    boolean
     */
    public function MaskAPIResult($api_result)
    {
     ...
     * @return    array
     */
    public function RefundTransaction($DataArray)
    {
     ...
     * @return    array
     */
    public function SetAccessPermissions($DataArray)
    {
        $SetAccessPermissionsNVP = '&METHOD=SetAccessPermissions';

        // SetAccessPermissions Fields
        $SetAccessPermissionsFields = isset($DataArray['SetAccessPermissionsFields']) ? $DataArray['SetAccessPermissionsFields'] : [];
        ...
        $n                   = 0;
        $RequiredPermissions = isset($DataArray['RequiredPermissions']) ? $DataArray['RequiredPermissions'] : [];
        ...
        $n                   = 0;
        $OptionalPermissions = isset($DataArray['OptionalPermissions']) ? $DataArray['OptionalPermissions'] : [];
     ...
     * @return    array
     */
    public function SetAuthFlowParam($DataArray)
    {
        $SetAuthFlowParamFieldsNVP = '&METHOD=SetAuthFlowParam';

        // SetAuthFlowParam Fields
        $SetAuthFlowParamFields = isset($DataArray['SetAuthFlowParamFields']) ? $DataArray['SetAuthFlowParamFields'] : [];
        ...
        $ShippingAddressFields = isset($DataArray['ShippingAddress']) ? $DataArray['ShippingAddress'] : [];
     ...
     * @return    array
     */
    public function SetCustomerBillingAgreement($DataArray)
    {
        $SCBAFieldsNVP        = '&METHOD=SetCustomerBillingAgreement';
        $BillingAgreementsNVP = '';

        $SCBAFields = isset($DataArray['SCBAFields']) ? $DataArray['SCBAFields'] : [];
        ...
        $BillingAgreements = isset($DataArray['BillingAgreements']) ? $DataArray['BillingAgreements'] : [];
        $n                 = 0;
    ...
    public function SetExpressCheckout($DataArray)
    {
        ...
        // Survey Choices
        $SurveyChoices = isset($DataArray['SurveyChoices']) ? $DataArray['SurveyChoices'] : [];
     ...
     * @return    array
     */
    public function SetMobileCheckout($DataArray)
    {
     ...
     * @return    array
     */
    public function TransactionSearch($DataArray)
    {
     ...
     * @return    array
     */
    public function UpdateAccessPermissions($PayerID)
    {
     ...
     * @return    array
     */
    public function UpdateRecurringPaymentsProfile($DataArray)
    {
        $URPPFieldsNVP = '&METHOD=UpdateRecurringPaymentsProfile';

        $URPPFields = isset($DataArray['URPPFields']) ? $DataArray['URPPFields'] : [];
     ...
     * @return    boolean
     */
    public function WarningsReturned($ack)
    {
