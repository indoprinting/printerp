...
<div class="box">
  <div class="box-header">
    <h2 class="blue"><i class="fa-fw fad fa-users"></i><?= lang('billers'); ?></h2>

    <div class="box-icon">
      <ul class="btn-tasks">
        <li class="dropdown">
          <a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon fad fa-tasks tip" data-placement="left" title="<?= lang('actions') ?>"></i></a>
          <ul class="dropdown-menu dropdown-menu-right tasks-menus" role="menu" aria-labelledby="dLabel">
            <li><a href="<?= admin_url('billers/add'); ?>" data-toggle="modal" data-target="#myModal" id="add"><i class="fad fa-fw fa-plus-circle"></i> <?= lang('add_biller'); ?></a></li>
            <li><a href="<?= admin_url('billers/import'); ?>" id="import" data-toggle="modal" data-backdrop="false" data-target="#myModal"><i class="fad fa-fw fa-upload"></i> <?= lang('add_billers_csv') ?></a></li>
            <li><a href="#" id="excel" data-action="export_excel"><i class="fad fa-fw fa-file-excel-o"></i> <?= lang('export_to_excel') ?></a></li>
            <li class="divider"></li>
            <li><a href="#" class="bpo" title="<b><?= $this->lang->line('delete_billers') ?></b>" data-content="<p><?= lang('r_u_sure') ?></p><button type='button' class='btn btn-danger' id='delete' data-action='delete'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button>" data-html="true" data-placement="left"><i class="fad fa-fw fa-trash-o"></i> <?= lang('delete_billers') ?></a></li>
          </ul>
        </li>
      </ul>
    </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="row">
          <div class="col-sm-3 float-right">
            <div class="input-group">
              <input id="dtfilter" class="form-control dtfilter" data-name="billers" placeholder="<?= lang('search'); ?>">
        ...
        <div class="table-responsive table-limit-height">
          <table id="SupData" cellpadding="0" cellspacing="0" borders="0"
