  ...
  <div class="container" style="position: relative; top: 30px">
    <div class="card transparent-black">
      ...
      <div class="card-body">
        ...
        <span style="color:white"><?= ( ! empty($warehouse) ? strtolower($warehouse->name) : ''); ?>@indoprinting.co.id</span>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <ul>
            <li>durian@indoprinting.co.id</li>
            <li>tembalang@indoprinting.co.id</li>
            <li>ngesrep@indoprinting.co.id</li>
          </ul>
        </div>
      </div>
    </div>
