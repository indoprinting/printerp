...
<script type="text/javascript">
  ...
  ?>
    ...
    localStorage.setItem('qaref', '<?= $adjustment->reference; ?>');
...
<div class="box">
  <div class="box-header">
    <h2 class="blue"><i class="fa-fw fad fa-plus"></i><?= lang('edit_adjustment'); ?></h2>
  </div>
          ...
          ?>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <?php echo form_input('reference', (isset($_POST['reference']) ? $_POST['reference'] : $adjustment->reference), 'class="form-control input-tip" id="qaref" readonly="readonly"'); ?>
              </div>
            </div>
            ...
            <div class="clearfix"></div>
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  ?>
                  <?= form_dropdown('mode', $modes, $adjustment->mode, 'class="form-control" id="mode" required="required"'); ?>
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
