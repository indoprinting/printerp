...
<div class="tab-content">
  <div id="details" class="tab-pane fade in">
    ...
    <div class="box">
      <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-file nb"></i> <?= $product->name . (SHOP && $product->hide != 1 ? ' (' . lang('shop_views') . ': ' . $product->views . ')' : ''); ?></h2>
          ...
          <ul class="btn-tasks">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu pull-right tasks-menus" role="menu"
                ...
                <li class="divider"></li>
                <li>
                  <a href="#" class="bpo" title="<?= lang('delete_product') ?>"
      ...
      echo '</div>';
                  ...
                  <table class="table table-borderless table-striped dfTable table-right-left">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= $this->sma->formatMoney(getMarkonPrice($product->cost, $product->markon)); ?></td>
                      </tr>
                        <?php } ?>
                      <?php } else { ?>
                      ...
                      <tr>
                        ...
                        <td><?= $this->sma->formatQuantity($product->safety_stock, 2); ?></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
            ...
            <div class="buttons">
              <div class="btn-group btn-group-justified">
                ...
                <div class="btn-group">
                  <a href="#" class="tip btn btn-danger bpo" title="<?= lang('delete_product') ?>"
                    data-content="<div style='width:150px;'><p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' href='<?= admin_url('products/delete/' . $product->id) ?>'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button></div>"
                    data-html="true" data-placement="top">
                    <i class="fa fa-trash"></i> <span class="hidden-sm hidden-xs"><?= lang('delete') ?></span>
                  </a>
                </div>
              </div>
            </div>
  ...
  <div id="chart" class="tab-pane fade">
    ...
    <div class="box">
      <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-chart-bar nb"></i><?= lang('chart'); ?></h2>
      </div>
      <div class="box-content">
        <div class="row">
          <div class="col-md-12">
            <div class="row" style="margin-bottom: 15px;">
              <div class="col-sm-<?= $purchased ? '6' : '12'; ?>">
                <div class="box" style="border-top: 1px solid #dbdee0;">
                  <div class="box-header">
                    <h2 class="blue"><i class="fa-fw fa fa-chart-bar"></i><?= lang('sold'); ?>
                    </h2>
                  </div>
                  <div class="box-content">
                    <div class="row">
              ...
              <?php if ($purchased) {
                ...
                <div class="col-sm-6">
                  <div class="box" style="border-top: 1px solid #dbdee0;">
                    <div class="box-header">
                      <h2 class="blue"><i
                          class="fa-fw fa fa-chart-bar"></i><?= lang('purchased'); ?></h2>
                    </div>
                    <div class="box-content">
                      <div class="row">
                        <div class="col-md-12">
  ...
  <div id="quotes" class="tab-pane fade">
    ...
    <div class="box">
      <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart nb"></i><?= $product->name . ' ' . lang('quotes'); ?>
        </h2>
