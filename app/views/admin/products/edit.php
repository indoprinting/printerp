...
<?php $productJS = json_decode($product->json_data); ?>
<div class="box">
  <div class="box-header">
    <h2 class="blue"><i class="fa-fw fad fa-plus"></i><?= lang('edit_product'); ?></h2>
  </div>
  <div class="box-content">
    <?= admin_form_open_multipart('products/edit/' . $product->id, ['data-toggle' => 'validator']); ?>
    <div class="row">
      <!-- LEFT COLUMN -->
      <div class="col-sm-6">
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  echo form_dropdown('type', $opt, $product->type, 'class="form-control select" id="type" style="width:100%;" required="required"')
                  ?>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <?= form_input('code', $product->code, 'class="form-control" id="code" required="required"'); ?>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <?= form_input('name', $product->name, 'class="form-control" id="name" required="required"'); ?>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <?= form_input('cost', formatDecimal($product->cost), 'class="form-control currency" id="cost"'); ?>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <?= form_input('price', formatDecimal($product->price), 'class="form-control currency" id="price" required="required"'); ?>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <?= form_input('min_order_qty', roundDecimal($product->min_order_qty), 'class="form-control" id="min_order_qty" required="required"'); ?>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <?= form_input('warehouses', $product->warehouses, 'class="form-control tip" id="warehouses" title="-Durian = Exclude Durian. Durian = Durian only."'); ?>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <select id="priority" class="select2" name="priority" style="width:100%;">
                    <?php for ($x = 1; $x < 4; $x++) : ?>
                      <?php $selected = (isset($productJS->priority) ? ($productJS->priority == $x ? ' selected' : '') : ''); ?>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <?= form_input('sn', ($productJS->sn ?? ''), 'class="form-control tip" id="sn" title="Serial Number"'); ?>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <?= form_input('purchased_at', ($productJS->purchased_at ?? ''), 'class="form-control tip date" id="purchased" title="Purchased Date"'); ?>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="form-group">
                  ...
                  if ($categories) {
                    ...
                    foreach ($categories as $cat) {
                      $opt[$cat->code] = '(' . $cat->code . ') ' . $cat->name;
                    }
                  }

                  $category = $this->site->getProductCategoryByID($product->category_id);

                  echo form_dropdown('category', $opt, ($category ? $category->code : ''), 'class="form-control select" id="category" style="width:100%;" required="required"')
                  ?>
                </div>
              </div>
            </div>
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-sm-12">
                ...
                echo form_dropdown('iuse_type', $opt, $product->iuse_type, 'class="form-control select" id="iuse_type" style="width:100%;"');
                ?>
              </div>
            </div>
          </div>
        ...
        <div class="panel panel-primary combo-items">
          ...
          if ($product->type == 'combo') {
            $combo_items = $this->site->getProductComboItems($product->id);
            if ($combo_items) {
              foreach ($combo_items as $combo_item) {
                $rnd = bin2hex(random_bytes(8));
                $cbitems[$rnd] = [
                  'row_id'   => $rnd,
                  'code'     => $combo_item->code,
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  <?= lang('markon', 'markon'); ?>
                  <?= form_input('markon', formatDecimal($product->markon), 'class="form-control" id="markon"'); ?>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <?= form_input('markon_price', formatDecimal($product->markon_price), 'class="form-control currency" id="markon_price"'); ?>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <input type="number" name="min_prod_time" class="form-control" id="min_prod_time" step="0.1" value="<?= ($productJS->min_prod_time ?? ''); ?>">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <input type="number" name="prod_time_qty" class="form-control" id="prod_time_qty" step="0.1" value="<?= ($productJS->prod_time_qty ?? ''); ?>">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  echo form_dropdown('unit', $opt, $product->unit, 'class="form-control select" id="unit" style="width:100%;"')
                  ?>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <?php
                  $opt = [];
                  echo form_dropdown('sale_unit', $opt, $product->sale_unit, 'class="form-control select" id="sale_unit" style="width:100%;"')
                  ?>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <?php
                  $opt = [];
                  echo form_dropdown('purchase_unit', $opt, $product->purchase_unit, 'class="form-control select" id="purchase_unit" style="width:100%;"')
                  ?>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <input class="form-control" id="safety_stock_ratio" name="safety_stock_ratio" step="0.1" type="number" value="<?= filterDecimal($product->safety_stock_ratio); ?>">
                </div>
              </div>
            </div>
              ...
              <tbody>
                ...
                if ($warehouses) {
                  foreach ($warehouses as $warehouse) {
                    $wh_product = $this->site->getWarehouseProduct($product->id, $warehouse->id);
                ?>
                    <tr>
                      <td><?= $warehouse->name; ?></td>
                      <td><input class="form-control text-center" name="safety_stock_<?= $warehouse->id; ?>" type="text" value="<?= ($wh_product ? roundDecimal($wh_product->safety_stock) : 0); ?>"></td>
                    </tr>
                <?php
                  }
                }
              ...
              <div class="col-sm-12">
                <table class="table table-bordered table-condensed table-hover table-striped">
                  ...
                  <tbody>
                    ...
                    <?php
                    $price_ranges = json_decode($product->price_ranges_value, TRUE);
                    ?>
                    <tr>
                      <td>Price Range 2</td>
                      <td><input class="form-control" name="price_ranges_value[]" placeholder="Min. Quantity" type="text" value="<?= ($price_ranges ? $price_ranges[0] : '') ?>"></td>
                    </tr>
                    <tr>
                      <td>Price Range 3</td>
                      <td><input class="form-control" name="price_ranges_value[]" placeholder="Min. Quantity" type="text" value="<?= ($price_ranges ? $price_ranges[1] : '') ?>"></td>
                    </tr>
                    <tr>
                      <td>Price Range 4</td>
                      <td><input class="form-control" name="price_ranges_value[]" placeholder="Min. Quantity" type="text" value="<?= ($price_ranges ? $price_ranges[2] : '') ?>"></td>
                    </tr>
                    <tr>
                      <td>Price Range 5</td>
                      <td><input class="form-control" name="price_ranges_value[]" placeholder="Min. Quantity" type="text" value="<?= ($price_ranges ? $price_ranges[3] : '') ?>"></td>
                    </tr>
                    <tr>
                      <td>Price Range 6</td>
                      <td><input class="form-control" name="price_ranges_value[]" placeholder="Min. Quantity" type="text" value="<?= ($price_ranges ? $price_ranges[4] : '') ?>"></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div class="col-sm-12">
                ...
                if ($price_groups) {
                  foreach ($price_groups as $price_group) {
                    $product_price = $this->site->getProductGroupPrice($product->id, $price_group->id);
                ?>
                    <table class="table table-bordered table-condensed table-hover table-striped">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          <td>Price Range 1</td>
                          <td><input class="form-control currency" name="price_groups_<?= $price_group->id; ?>[]" type="text" value="<?= ($product_price ? formatDecimal($product_price->price) : ''); ?>"></td>
                        </tr>
                        <tr>
                          <td>Price Range 2</td>
                          <td><input class="form-control currency" name="price_groups_<?= $price_group->id; ?>[]" type="text" value="<?= ($product_price ? formatDecimal($product_price->price2) : ''); ?>"></td>
                        </tr>
                        <tr>
                          <td>Price Range 3</td>
                          <td><input class="form-control currency" name="price_groups_<?= $price_group->id; ?>[]" type="text" value="<?= ($product_price ? formatDecimal($product_price->price3) : ''); ?>"></td>
                        </tr>
                        <tr>
                          <td>Price Range 4</td>
                          <td><input class="form-control currency" name="price_groups_<?= $price_group->id; ?>[]" type="text" value="<?= ($product_price ? formatDecimal($product_price->price4) : ''); ?>"></td>
                        </tr>
                        <tr>
                          <td>Price Range 5</td>
                          <td><input class="form-control currency" name="price_groups_<?= $price_group->id; ?>[]" type="text" value="<?= ($product_price ? formatDecimal($product_price->price5) : ''); ?>"></td>
                        </tr>
                        <tr>
                          <td>Price Range 6</td>
                          <td><input class="form-control currency" name="price_groups_<?= $price_group->id; ?>[]" type="text" value="<?= ($product_price ? formatDecimal($product_price->price6) : '');; ?>"></td>
                        </tr>
                      </tbody>
                    </table>
                <?php
        ...
        <div class="panel panel-primary stock-opname">
          ...
          <div class="panel-body" style="overflow-x: auto;">
            ...
            if ($warehouses) {
              foreach ($warehouses as $warehouse) {
                $wh_product = $this->site->getWarehouseProduct($product->id, $warehouse->id);
                $pic_ids[] = ($wh_product ? $wh_product->user_id : NULL);
                $wh_ids[]  = $warehouse->id;
            ?>
                <table class="table table-bordered table-condensed table-hover table-striped">
                  <thead>
                    ...
                    <tr>
                      <td>
                        <div class="input-group">
                          <?php
                          $opt = [];
                          echo form_dropdown('pic_' . $warehouse->id, $opt, '', 'class="form-control user" id="pic_' . $warehouse->id . '" data-placeholder="Select PIC" style="width:100%;"');
                          ?>
                          <div class="input-group-addon" style="padding:0 10px;">
                      ...
                      <td class="col-sm-4">
                        <div class="form-group">
                          ...
                          <input class="form-control" name="cycle_<?= $warehouse->id; ?>" type="number" value="<?= ($wh_product ? $wh_product->so_cycle : 0); ?>">
                        </div>
                      </td>
                    </tr>
                  </tbody>
                ...
                if ($warehouses) {
                  foreach ($warehouses as $warehouse) { ?>
                    <tr>
                      <td><?= $warehouse->name; ?></td>
                      <?php
                      $warehouse_product = $this->site->getWarehouseProduct($product->id, $warehouse->id); // param2 = product->id
                      if ($warehouse_product) {
                        $item_total += $warehouse_product->quantity;
                      }
                      ?>
                      <td class="text-right"><?= ($warehouse_product ? formatStock($warehouse_product->quantity) : 0); ?></td>
                    </tr>
                <?php
                  }
                }
...
<script>
  $(document).ready(function() {
    let cbitems = JSON.parse('<?= json_encode($cbitems); ?>');
    // let category_code = '<?= ($product->category_id ? $this->site->getProductCategoryByID($product->category_id)->code : ''); ?>';
    let subcategory_code = '<?= ($product->subcategory_id ? $this->site->getProductCategoryByID($product->subcategory_id)->code : ''); ?>';
    let supplier_id = '<?= $product->supplier_id; ?>';
    let sale_unit_id = '<?= $product->sale_unit; ?>';
    let purchase_unit_id = '<?= $product->purchase_unit; ?>';
    ...
    for (let a in wh_ids) {
      if (pic_ids[a]) {
        preSelectUser('#pic_' + wh_ids[a], pic_ids[a]);
      }
    }
    ...
    if (autocomplete == 1) {
      $('#autocomplete').iCheck('check');
    }

    preSelectCategory('#subcategory', subcategory_code);
    // preSelectSubCategory('#subcategory', category_code);
    preSelectSupplier('#supplier', supplier_id);
    preSelectSubUnit('#sale_unit', sale_unit_id);
    preSelectSubUnit('#purchase_unit', purchase_unit_id);
