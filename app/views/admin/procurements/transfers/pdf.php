...
<head>
    ...
    <title><?= $this->lang->line('transfer') . ' ' . $transfer->reference; ?></title>
    ...
    $base64 = 'data:image/' . $type . ';base64,' . base64_encode($data); ?>
                ...
                <div class="well well-sm">
                    ...
                    <div class="col-xs-6 pull-right text-right order_barcodes">
                        <?php
                        $path   = admin_url('misc/barcode/' . $this->sma->base64url_encode($transfer->reference) . '/code128/74/0/1');
                        $type   = $Settings->barcode_img ? 'png' : 'svg+xml';
                        $data   = file_get_contents($path);
                        $base64 = 'data:image/' . $type . ';base64,' . base64_encode($data);
                        ?>
                        <img src="<?= $base64; ?>" alt="<?= $transfer->reference; ?>" class="bcimg" />
