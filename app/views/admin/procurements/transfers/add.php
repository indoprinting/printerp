...
<script type="text/javascript">
  ...
  <?php } ?>
  var count = 1, an = 1, product_variant = 0, shipping = 0, total = 0, toitems = {};
  $(document).ready(function () {
    ...
    $("#add_item").autocomplete({
      source: function (request, response) {
        ...
        $.ajax({
          type: 'get',
          url: '<?= admin_url('procurements/transfers/suggestions'); ?>',
          dataType: "json",
          data: {
            term: request.term,
      ...
      select: function (event, ui) {
        let to_warehouse = localStorage.getItem('to_warehouse');
  ...
  <div class="box-content">
    <div class="row">
      <div class="col-lg-12">
        ...
        echo admin_form_open_multipart('procurements/transfers/add', $attrib) ?>
        ...
        <div class="row">
          <div class="col-lg-12">
                ...
                <div class="table-responsive controls table-controls">
                  <table id="toTable" class="table items table-striped table-bordered table-condensed table-hover sortable_table">
                    ...
                    <tr>
                      ...
                      <th><?= lang('subtotal'); ?> (<span class="currency"><?= $default_currency->symbol ?></span>)
                      </th>
            ...
            <div class="col-md-12">
              <div
                class="from-group"><?php echo form_submit('add_transfer', lang('submit'), 'id="add_transfer" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
...
<div class="modal" id="prModal" tabindex="-1" data-backdrop="false" role="dialog" aria-labelledby="prModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="pr_popover_content">
        <form class="form-horizontal" role="form">
          ...
          <div class="form-group">
            <label for="pprice" class="col-sm-4 control-label"><?= lang('markon_price') ?></label>
