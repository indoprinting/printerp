...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    localStorage.setItem('tonote', '<?= $this->sma->decode_html($transfer->note); ?>');
		...
		localStorage.setItem('update_mode', false); // Enable to_warehouse editing. See transfers.js.
		<?php } ?>
    <?php if ($Owner || $Admin) { ?>
...
<div class="box">
  <div class="box-header">
    <h2 class="blue"><i class="fa-fw fad fa-edit"></i><?= lang('edit_transfer'); ?></h2>
  </div>
  <div class="box-content">
    <div class="row">
      <div class="col-lg-12">
        ...
        echo admin_form_open_multipart('procurements/transfers/edit/' . $transfer->id, $attrib)
        ?>
        <div class="row">
          <div class="col-lg-12">
            <div class="col-md-4">
              <div class="form-group">
                <?= lang('date', 'todate'); ?>
                <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : $transfer->date), 'class="form-control input-tip date" id="todate" required="required"'); ?>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="form-group" style="margin-bottom:0;">
                  <div class="input-group wide-tip">
                    <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;">
                      <i class="fad fa-barcode addIcon"></i></a></div>
