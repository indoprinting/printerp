...
<script type="text/javascript">
  ...
  $(window).bind("load", function() {
    if (purchase_status == 'received' || purchase_status == 'partial') {
      $(".rec_con").show();
    } else {
      $(".rec_con").hide();
    }
  ...
  ?>
    ...
    localStorage.setItem('poref', '<?=$inv->reference?>');
    ...
    localStorage.setItem('approve_mode', true);
    <?php
} ?>
    ...
    $("#add_item").autocomplete({
      source: '<?= admin_url('procurements/purchases/suggestions'); ?>',
      minLength: 1,
      autoFocus: false,
      delay: 250,
    ...
    $(window).bind('beforeunload', function (e) {
      localStorage.removeItem('approve_mode');
...
<div class="box">
  <div class="box-header">
    <h2 class="blue"><i class="fa-fw fa fa-edit"></i><?= lang('approve_purchase'); ?></h2>
  </div>
  <div class="box-content">
    <div class="row">
      <div class="col-lg-12">
        ...
        echo admin_form_open_multipart('procurements/purchases/approve/' . $inv->id, $attrib)
        ?>
          ...
          ?>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <?php echo form_input('reference', (isset($_POST['reference']) ? $_POST['reference'] : $purchase->reference), 'class="form-control input-tip" id="poref" required="required" readonly="readonly"'); ?>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : $purchase->warehouse_id), 'id="powarehouse" class="form-control input-tip select" data-placeholder="' . $this->lang->line('select') . ' ' . $this->lang->line('warehouse') . '" required="required" disabled="disabled" style="width:100%;" ');
                ?>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <?php
                $post = ['pending' => lang('pending'), 'approved' => lang('approved'), 'ordered' => lang('ordered'), 'received' => lang('received')];
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input id="document" type="file" data-browse-label="<?= lang('browse'); ?>" name="document" data-show-upload="false"
                     data-show-preview="false" class="form-control file" disabled="disabled">
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="from-group">
                <?php echo form_submit('approve_purchase', $this->lang->line('submit'), 'id="approve_purchase" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="approveItem"><?= lang('submit') ?></button>
      </div>
    </div>
  </div>
</div>
...
<script>
  ...
  if (status == 'received') {
    $('#approve_purchase').prop('disabled', true);
    $('#reset').prop('disabled', true);
    $('#postatus').prop('disabled', true);
  }
</script>