...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    echo admin_form_open_multipart('procurements/purchases/edit_payment/' . $payment->id, $attrib); ?>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input name="old_amount" id="old_amount"
                  value="<?= $this->sma->formatDecimal($payment->amount); ?>"
                  class="form-control amount currency" type="text" readonly>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <?= lang('new_amount', 'new_amount'); ?>
                <input name="new_amount" id="new_amount"
                  value="<?= $this->sma->formatDecimal($payment->amount); ?>"
