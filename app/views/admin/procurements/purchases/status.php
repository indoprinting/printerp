...
<script type="text/javascript">
  var count = 1, an = 1, po_edit = false, total = 0, poitems = {};
  ...
  $(document).ready(function () {
    ...
    localStorage.setItem('status_mode', true); // Disable purchased quantity editing.
    <?php } ?>
...
<div class="box">
  <div class="box-header">
    <h2 class="blue"><i class="fad fa-binoculars"></i><?= lang('purchase_status'); ?></h2>
  </div>
  <div class="box-content">
    <div class="row">
      <div class="col-lg-12">
        ...
        echo admin_form_open_multipart('procurements/purchases/status/' . $purchase->id, $attrib); ?>
                  ...
                  <div class="input-group wide-tip">
                    ...
                    <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;">
                      <a href="<?= admin_url('products/add') ?>" id="addManually1"><i
                          class="fad fa-plus-circle addIcon" id="addIcon"></i></a></div>
                    <?php } ?>
                  </div>
                </div>
                <div class="clearfix"></div>
              ...
              <div class="row" id="extras-con" style="display: none;">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <?php echo form_input('payment_term', $purchase->payment_term, 'class="form-control tip" data-trigger="focus" data-placement="top" title="' . lang('payment_term_tip') . '" id="popayment_term"'); ?>
                  </div>
                </div>
              </div>
              <div class="clearfix"></div>
