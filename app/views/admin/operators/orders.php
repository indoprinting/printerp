          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                ?>
                <?= form_multiselect('warehouses[]', $bl, ($warehouses ?? ''), 'class="form-control" id="warehouses" data-placeholder="Select Warehouses" style="width:100%;"'); ?>
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
                <label><?= lang('created_by'); ?></label>
                <input name="created_by" id="created_by" class="form-control" type="text" value="<?= ($created_by ?? ''); ?>">
              </div>
            </div>
          </div>
          <div class="row">
