      ...
      <div class="container">
        ...
        <div class="header-nav">
          ...
          <ul class="nav navbar-nav pull-right">
            ...
            <?php if ($Owner || $Admin || getPermission('edit-system')) { ?>
                  ...
                  <ul class="nav main-menu">
                    ...
                    <?php if (
                      ...
                      <li class="mm_finances">
                        ...
                        <ul>
                          <?php if ($Owner || $Admin || $GP['banks-index']) : ?>
                          ...
                          <?php if ($Owner || $Admin || $GP['banks-add']) : ?>
                          ...
                          <?php if ($Owner || $Admin || $GP['banks-reconciliation']) : ?>
                          ...
                          <?php if ($Owner || $Admin || $GP['mutations-index']) : ?>
                          ...
                          <?php if ($Owner || $Admin || $GP['mutations-add']) : ?>
                          ...
                          <?php if ($Owner || $Admin || $GP['expenses-add']) : ?>
                          ...
                          <?php if ($Owner || $Admin || $GP['incomes-index']) : ?>
                          ...
                          <?php if ($Owner || $Admin || $GP['incomes-add']) : ?>
                          ...
                          <?php if ($Owner || $Admin || $GP['validations-index']) : ?>
                    ...
                    <?php if (
                      ...
                      <li class="mm_operators">
                        ...
                        <ul>
                          <?php if ($Owner || $Admin || $GP['operators-orders']) : ?>
                          ...
                          <?php endif; ?>
                          <?php if ($Owner || $Admin || $GP['operators-checkpoint']) : ?>
                    ...
                    <?php if (
                      ...
                      <li class="mm_procurements">
                        ...
                        <ul>
                          <?php if ($Owner || $Admin || $GP['internal_uses-index']) : ?>
                          ...
                          <?php endif; ?>
                          <?php if ($Owner || $Admin || $GP['internal_uses-add']) : ?>
                    ...
                    <?php if ($Owner || $Admin || getPermission('notify-index')) : ?>
                    ...
                    <?php if (
                      $Owner || $Admin || $GP['reports-payments'] || $GP['reports-sales'] || getPermission('reports-printerp')
                    ) : ?>
                      <li class="mm_reports">
                        <a class="dropmenu" href="#">
                        ...
                        <ul>
                          <?php if ($Owner || $Admin || getPermission('reports-printerp')) : ?>
                          ...
                          <?php if ($Owner || $Admin || $GP['reports-income_statement']) : ?>
                          ...
                          <?php if ($Owner || $Admin || $GP['reports-inventory_balance']) : ?>
