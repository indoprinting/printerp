    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          ?>
          <?= form_dropdown('category', $ct, $income->category_id, 'class="form-control select tip" id="category" required="required"'); ?>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          echo form_dropdown('biller', $wh, $income->biller_id, 'id="biller" class="form-control input-tip select" placeholder="Select biller" required="required"');
          ?>
        </div>
      </div>
      <div class="col-md-6">
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-md-6">
              ...
              ?>
              <?= form_dropdown('transfer_to', $bk, $income->bank_id, 'class="form-control select tip" id="transfer_to" placeholder="Select Transfer To" required="required"'); ?>
            </div>
            <div class="col-md-6">
