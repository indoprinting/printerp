          ...
          <div class="login-form-div">
            <div class="login-content">
              ...
              <div class="form-action col-sm-12">
                ...
                <button type="submit" class="btn btn-success pull-right"><?= lang('login') ?> &nbsp; <i class="fad fa-sign-in"></i></button>
              </div>
              <?php echo form_close(); ?>
            ...
            <div class="login-form-links link2 display-none">
          ...
          <div class="login-form-div">
            <div class="login-content">
              ...
              <div class="col-sm-12">
                ...
                <div class="textbox-wrap form-group">
                  <div class="input-group">
                    <span class="input-group-addon "><i class="fad fa-envelope"></i></span>
                ...
                <div class="form-action">
                  <a class="btn btn-success pull-left login_link" href="#login">
                    <i class="fad fa-chevron-left"></i> <?= lang('back') ?>
                  </a>
                  <button type="submit" class="btn btn-primary pull-right">
                    <?= lang('submit') ?> &nbsp;&nbsp; <i class="fad fa-envelope"></i>
                  </button>
                </div>
              </div>
              <?php echo form_close(); ?>
            ...
            <div class="registration-form-div reg-content">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon "><i class="fad fa-building"></i></span>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <?= lang('phone', 'phone'); ?>
                  <div class="input-group">
                    <span class="input-group-addon "><i class="fad fa-phone-square"></i></span>
              ...
              <div class="col-sm-12">
                ...
                <button type="submit" class="btn btn-primary pull-right">
                  <?= lang('register_now') ?> <i class="fad fa-user"></i>
                </button>
              </div>
