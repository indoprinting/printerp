        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              ?>
              <?= form_dropdown('timezone', $tz, TIMEZONE, 'class="form-control tip" id="timezone" required="required" style="width:100%;"'); ?>
            </div>
          </div>
          <!--<div class="col-md-4">
            <div class="form-group">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              if ( ! empty($billers)) {
                ...
                echo form_dropdown('biller', 'No Billers found', '', 'id="biller" data-placeholder="' . lang('select') . ' ' . lang('biller') . '" required="required" class="form-control input-tip select" style="width:100%;" disabled');
              }
              ?>
            </div>
          </div>
          ...
          <fieldset class="scheduler-border">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label class="control-label" for="overselling"
                  data-toggle="popover" data-content="You can sell item even the quantity of item is 0 (zero) if you enabled it." data-trigger="hover"><?= lang('over_selling'); ?></label>
            ...
            <!-- <div class="col-md-4" id="states" style="display: none;">
              <div class="form-group">
                ...
                <div class="controls">
                  ...
                  echo form_dropdown('state', '', $Settings->state, 'class="form-control tip" required="required" id="state" style="width:100%;"');
                  ?>
                </div>
              </div>
            </div> -->
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <?= form_password('smtp_pass', $Settings->smtp_pass, 'class="form-control tip" id="smtp_pass" autocomplete="off"'); ?> </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="control-label"
