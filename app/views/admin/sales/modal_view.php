          ...
          <table class="table table-bordered table-condensed table-hover table-striped print-table order-table">
              ...
              ?>
                  <tr>
                    ...
                    <td style="text-align:right; width:100px;">
                      <?= $this->sma->formatMoney($row->price); ?>
                    </td>
            ...
            <tfoot>
              ...
              <tr>
                ...
                </td><td class="td-own" colspan="5" style="text-align:right; font-weight:bold;"><?= lang('discount'); ?>
                  (<?= $default_currency->code; ?>)
                </td>
                <td style="text-align:right; font-weight:bold;"><?= ($inv->discount > 0 ? '-' . formatCurrency($inv->discount): formatCurrency(0)); ?></td>
              </tr>
              <tr>
              <td class="td-own" colspan="5" style="text-align:right; font-weight:bold;"><?= lang('grand_total'); ?>
                  (<?= $default_currency->code; ?>)
                </td>
                <td style="text-align:right; font-weight:bold;"><?= formatCurrency($inv->grand_total); ?></td>
              </tr>
              <tr>
                <td class="td-own" colspan="5" style="text-align:right; font-weight:bold;"><?= lang('paid'); ?>
                  (<?= $default_currency->code; ?>)
                </td>
                <td style="text-align:right; font-weight:bold;"><?= formatCurrency($inv->paid); ?></td>
              </tr>
              <tr>
                <td class="td-own" colspan="5" style="text-align:right; font-weight:bold;"><?= lang('balance'); ?>
                  (<?= $default_currency->code; ?>)
                </td>
