...
<script>
  $(document).ready(function() {
    oTable = $('#Table').dataTable({
      ...
      'bProcessing': true,
      'bServerSide': true,
      'sAjaxSource': '<?= admin_url('sales/getSalesTBPayment?' . $q); ?>',
...
<div class="box">
  <div class="box-header">
    <h2 class="blue"><i class="fa fa-fw fa-exchange"></i>Sales TB Payment</h2>
    <div class="box-icon">
      <ul class="btn-tasks">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-right tasks-menus">
            ...
            <li>
              <a href="#" id="deleteSalesTB">
                <i class="fa fa-fw fa-trash"></i> Delete Sales TB Payment
              </a>
            </li>
          </ul>
        </li>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <a href="#" class="btn btn-success" id="syncSalesTB"><i class="fad fa-sync"></i> Sync Sales TB Payment</a>
  ...
  $(document).ready(function() {
    ...
    $('#deleteSalesTB').click(function() {
      addConfirm({
        ...
        message: 'Are you sure to delete selected Sales TB Payment?',
        onok: () => {
          let data = {};
          ...
          $.ajax({
            ...
            url: site.base_url + 'sales/deleteSalesTBPayment'
          });
        }
      });
    });
    ...
    $('#doFilter').click(function(e) {
      ...
      location.href = site.base_url + 'sales/tb_payment?' + q;
    });

    $('#processPayments').click(function(e) {
      addConfirm({
        title: 'Process Sales TB Payments',
        message: 'Are you sure to process selected Sales TB Payment?',
        onok: () => {
          let data = {};
          data[security.csrf_token_name] = security.csrf_hash;
          data.val = [];
          ...
          $.ajax({
            ...
            url: site.base_url + 'sales/processSalesTBPayment'
          });
        }
      });
    });
    ...
    $('#syncSalesTB').click(function(e) {
      ...
      $.ajax({
        ...
        url: site.base_url + 'sales/syncSalesTBPayment?' + q
      })
    });
  });
