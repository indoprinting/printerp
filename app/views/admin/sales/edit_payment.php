      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="well well-sm well-info">
            ...
            ?>
            <?= form_dropdown('created_by', $usr, $payment->created_by, 'class="form-control select" id="ep_created_by" style="width:100%;"'); ?>
          </div>
        </div>
        <?php } else { ?>
        ...
        <div class="col-sm-6">
          <div class="well well-sm">
            <div class="form-group">
              ...
              <select id="payment_method" class="form-control select" name="payment_method" style="width:100%;">
        ...
        <div class="col-sm-6">
          <div class="well well-sm bank_id" style="display: none">
            <div class="form-group">
              ...
              <select id="bank_id" class="form-control select" name="bank_id" style="width:100%;">
              </select>
            </div>
          </div>
        </div>
