...
class Sync extends MY_Controller
{
  ...
  public function sales () {
    if ($this->site->syncSales()) {
      die('<i class="fa fa-check"></i> Sales has been synced succesfully.');
    } else {
      die('<i class="fa fa-times"></i> Sales cannot be synced.');
    }
  }
  ...
  public function index()
  {
    ...
    $this->page_construct('syncdb/index', $this->data);
  }
